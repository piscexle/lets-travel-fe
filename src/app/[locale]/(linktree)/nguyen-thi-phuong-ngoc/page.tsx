...
const ProfilePage = () => {
  const contactUs = (type: string) => {
    if (type === 'email') {
      ...
      window.location.href = `mailto:anmediatv.lam@gmail.com ?subject=${subject}`;
    } else {
      window.location.href = 'tel:0932702486';
    }
  };
  return (
      ...
      <div className="wrapper-profile">
        <div className="wrapper-profile-header">
          <div className="wrapper-profile-header-avatar">
            <Image
              src="/images/ngoc-avatar.jpg"
              fill
              placeholder="blur"
              blurDataURL={createRGBDataURL(199, 199, 199)}
              alt="Nguyễn Thị Phương Ngọc"
              sizes="100%"
            />
          </div>
          <h1 className="wrapper-profile-header-name">Nguyễn Thị Phương Ngọc</h1>
          <p className="wrapper-profile-header-company">
            PNL Digital Transformation Solutions Company
          </p>
          <p className="wrapper-profile-header-desc">GĐKD & VHDN/CMO</p>
        </div>
        ...
        <Row gutter={[16, 16]}>
          ...
          <Col xs={24} sm={24} md={12} lg={12} xl={12}>
            <LinkItem
              ...
              titleBtn="QR của tôi"
              type="qr"
              imageQrCode="https://res.cloudinary.com/dvv3iwbyz/image/upload/v1710985623/chi_ngoc_e0jaes.png"
            />
          </Col>
        </Row>
        <FooterLink />
